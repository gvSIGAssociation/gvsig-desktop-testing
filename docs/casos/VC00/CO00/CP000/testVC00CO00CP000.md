...
8. ${check} Siga los pasos de [Obtención de una copia local (checkout) desde repositorio sin autenticación](../../PROC/005/procVC00PROC005.html?WCNAME=${WCNAME2}&TABLENAME=${TABLENAME}&USER=${USER}&PASSWORD=${PASSWORD})
